...
class PostActivity : AppCompatActivity() {
    ...
    private lateinit var productUnitAutoComplete: AutoCompleteTextView
    private lateinit var pricePerUnitSwitch: SwitchMaterial
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        productQuantityEditText = binding.productQuantityEditText
        productUnitAutoComplete = binding.productUnitAutoComplete
        pricePerUnitSwitch = binding.pricePerUnitSwitch
        ...
        btnPost.setOnClickListener {
            if (imagePath != null) {
                ...
                val unit = productUnitAutoComplete.text.toString().trim()

                if (productName.isEmpty() || productPrice.isEmpty() || productCategory.isEmpty() ||
                    productAvailability.isEmpty() || productDescription.isEmpty() || quantity.isEmpty()) {
    ...
    private fun setupUnitDropdown() {
        ...
        productUnitAutoComplete.setAdapter(adapter)
        productUnitAutoComplete.setText(Post.UNIT_KG, false) // Set default value
    }
    ...
    private fun savePostToFirestore(
        ...
        if (user != null) {
            ...
            val quantity = productQuantityEditText.text.toString().toDoubleOrNull() ?: 0.0
            val unit = productUnitAutoComplete.text.toString().takeIf { it.isNotBlank() } ?: Post.UNIT_KG
            val isPricePerUnit = pricePerUnitSwitch.isChecked
            ...
            val post = Post().apply {
                ...
                this.unit = unit
                this.pricePerUnit = isPricePerUnit
                this.productDescription = productDescription
                isArchived = false
